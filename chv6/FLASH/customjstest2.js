...
vjs.MediaError.defaultMessages = {
  ...
  4: 'Aw, snap! This channel is seems to be offline. Please try different channel instead or help the project by uploading working link for this channel thanks.',
...
vjs.Flash['onError'] = function(swfID, err){
  var player = vjs.el(swfID)['player'];
  var msg = 'Aw, snap!  '+e09r;

  if (err == 'This channel is either offline or is not compatible with player due to cross domain policy issue with stream.Please try different channel instead or help the project by uploading link for this channel thanks. ') {
