...
vjs.MediaError.defaultMessages = {
  ...
  4: 'This channel seems to be offline. Please try different channel instead or help the project by uploading working link for this channel thanks.',
...
vjs.Flash['onError'] = function(swfID, err){
  var player = vjs.el(swfID)['player'];
  var msg = 'This channel is either offline or is not compatible with the flash player. Please try different channel instead. For more information,Please go to ccloudtv.org/faqs thanks.Error: '+err;
